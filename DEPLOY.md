...
4. **Every citation URL is verified.** Authoring agents WebFetch-verify and drop dead URLs. Re-check with `python3 scripts/verify_citation_urls.py json/<platform>` from a normal network (sandbox IPs get 429-throttled by Google/Meta help — a 429 is not a broken link; a 404/410/5xx is).
